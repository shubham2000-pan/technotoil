            ...
            <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                     <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                            <label for="password-confirm" class="mdl-textfield__label text-md-right">{{ __('Date of Birth') }}</label>

                    
                            <div class="col-md-6">
                                <input id="password-confirm" type="date" class="mdl-textfield__input" name="dob" required>
                            </div>
                        </div>
